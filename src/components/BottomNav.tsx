...
import { Home, CalendarDays, PlusCircle, Heart, Bot, NotebookPen } from "lucide-react";
        ...
        {tabs.map(({ path, icon: Icon, label }) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-1 px-1.5 py-2 min-w-0 transition-all duration-300 ${
                isActive
                  ? "text-energy"
